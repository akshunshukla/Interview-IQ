      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-10 animate-fade-in">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-500 hover:to-teal-500 transition-all shadow-lg shadow-emerald-500/15 hover:shadow-emerald-500/25"
          >
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 outline-none transition-all"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 outline-none resize-none transition-all"
              ...
              <div className="md:col-span-2 flex items-center gap-3 p-4 bg-zinc-950 border border-zinc-800 rounded-xl">
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    isUnlisted ? "bg-emerald-600" : "bg-zinc-700"
                  }`}
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                      isUnlisted ? "translate-x-5" : ""
                    }`}
                  />
                </button>
                <div>
              ...
              <div className="flex items-end">
                <button
                  type="submit"
                  disabled={isCreating}
                  className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl px-4 py-3 hover:from-emerald-500 hover:to-teal-500 transition-all disabled:opacity-50 flex justify-center items-center gap-2 shadow-lg shadow-emerald-500/15"
                >
                  {isCreating ? (
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {job.isUnlisted && (
                        <span className="px-2.5 py-0.5 text-xs font-semibold rounded-full border bg-violet-500/10 text-violet-400 border-violet-500/20 flex items-center gap-1">
                    ...
                    {job.isUnlisted && job.accessCode && (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-violet-400 bg-violet-500/10 border border-violet-500/20 rounded-lg hover:bg-violet-500/20 transition-all"
                        >
                          {copiedCode === job.id ? (
                  ...
                  <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-emerald-400 transition-colors shrink-0 ml-4" />
                </button>
              ))}
            </div>
          )}
