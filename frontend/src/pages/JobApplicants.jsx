        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            {applications.map((app, index) => {
              ...
              const avgScore =
                totalScore !== null ? Math.round(totalScore) : null;
                      ...
                      {report && app.status === "APPLIED" && (
                        <>
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-white/10 border border-white/20 rounded-lg hover:bg-white/20 transition-all disabled:opacity-50"
                          >
                            {updatingId === app.id ? (
